...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    // final firstName =  loginResponse?.data.userData.firstName;
    // String nationality = loginResponse?.data.userData.profileId?.address ?? 'Unknown';
              ...
              Column(
                ...
                borderRadius: BorderRadius.circular(10), // Border radius
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          foregroundColor: Colors.red, backgroundColor: Colors.white, shape: CircleBorder(),
